...
Објаснувањето за како ги напишав unit тестовите се дадени како коментари во кодот но одприлика ја следев истата процедура како што ја наведов во 4тото и 5тото барање погоре но исто така ја користев матрицава со којашто ги пратев тест casesot преку break points користејќи debugger

![Matrica za test caseovi](https://github.com/user-attachments/assets/25cf8740-3276-444c-aff7-c30742c7070b)
